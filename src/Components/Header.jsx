  ...
  return (
    <div className="container-fluid">
      <div className="row">
        ...
        <div className="col-6 whatsapp_inquirey">
          <Link to="https://wa.me/+9237584398353" target="_blank" rel="noopener noreferrer" className="btn btn-outline-light">
            Whatsapp Us +9230978967
          </Link>
        </div>
      </div>
      <div className="row">
      ...
      <div className="row">
        <div className="col-12">
          <marquee className="marquee_msg">
            Tenders issued by the Local Government and Community Development Department (LG & CDD)
          </marquee>
        </div>
      </div>
    </div>
